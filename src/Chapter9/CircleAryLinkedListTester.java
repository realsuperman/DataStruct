...
public class CircleAryLinkedListTester {
    ...
    public static void main(String args[]){
        ...
        Data ptr;
        Data temp=new Data();
        CircleAryLinkedList<Data> list = new CircleAryLinkedList<>(100);
        do{
            switch (menu=SelectMenu()){
                ...
                case DUMP :
                    ...
                    break;
                case RETRIEVE :
                    System.out.print("몇번째 노드 검색?");
                    System.out.println(list.retrieve(sc.nextInt()));
                    break;
                case CLEAR :
                    list.clear();
                    break;
